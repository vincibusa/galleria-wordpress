<footer class="site-footer">
	<div class="container">
		<div class="footer-content">
			...
			<div class="footer-section footer-about">
				<h3><?php esc_html_e('Galleria Adalberto Catanzaro', 'galleria'); ?></h3>
					...
					<?php if (get_theme_mod('galleria_facebook') || get_theme_mod('galleria_instagram') || get_theme_mod('galleria_twitter') || get_theme_mod('galleria_linkedin')) : ?>
						<div class="social-links">
							<?php if (get_theme_mod('galleria_facebook')) : ?>
								<a href="<?php echo esc_url(get_theme_mod('galleria_facebook')); ?>" target="_blank" rel="noopener noreferrer" aria-label="<?php esc_attr_e('Seguici su Facebook', 'galleria'); ?>">
							...
							<?php if (get_theme_mod('galleria_instagram')) : ?>
								<a href="<?php echo esc_url(get_theme_mod('galleria_instagram')); ?>" target="_blank" rel="noopener noreferrer" aria-label="<?php esc_attr_e('Seguici su Instagram', 'galleria'); ?>">
									<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
							...
							<?php if (get_theme_mod('galleria_twitter')) : ?>
								<a href="<?php echo esc_url(get_theme_mod('galleria_twitter')); ?>" target="_blank" rel="noopener noreferrer" aria-label="<?php esc_attr_e('Seguici su Twitter', 'galleria'); ?>">
									<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
							...
							<?php if (get_theme_mod('galleria_linkedin')) : ?>
								<a href="<?php echo esc_url(get_theme_mod('galleria_linkedin')); ?>" target="_blank" rel="noopener noreferrer" aria-label="<?php esc_attr_e('Seguici su LinkedIn', 'galleria'); ?>">
									<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
		...
		<div class="footer-section footer-location-primary">
			<h3><?php esc_html_e('Sede Principale', 'galleria'); ?></h3>
			<p class="location-name"><?php esc_html_e('Via Montevergini', 'galleria'); ?></p>
			<div class="space-y-3">
		...
		<div class="footer-section footer-location-secondary">
			<h3><?php esc_html_e('Project Space', 'galleria'); ?></h3>
			<p class="location-name"><?php esc_html_e('Corso Vittorio Emanuele', 'galleria'); ?></p>
			<div class="space-y-3">
				<div class="footer-contact-item">
		...
		<div class="footer-section footer-contact">
			<h3><?php esc_html_e('Contatti', 'galleria'); ?></h3>
			<div class="space-y-3">
				<div class="footer-contact-item">
					<svg class="icon" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
						<path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path>
					</svg>
					<a href="tel:<?php echo esc_attr(str_replace(' ', '', get_theme_mod('galleria_phone', '+393271677871'))); ?>" aria-label="<?php esc_attr_e('Chiamaci', 'galleria'); ?>">
				...
				<div class="footer-contact-item">
					...
					<a href="mailto:<?php echo esc_attr(get_theme_mod('galleria_email', 'catanzaroepartners@gmail.com')); ?>" aria-label="<?php esc_attr_e('Inviaci una email', 'galleria'); ?>">
	...
	<div class="footer-bottom">
		<div class="footer-bottom-content">
			<p class="copyright">
				© <?php echo esc_html(date('Y')); ?> <?php bloginfo('name'); ?>. <?php esc_html_e('Tutti i diritti riservati.', 'galleria'); ?>
			</p>
			
			<button class="scroll-to-top" 
					title="<?php esc_attr_e('Torna su', 'galleria'); ?>"
					aria-label="<?php esc_attr_e('Torna all\'inizio della pagina', 'galleria'); ?>">
				<span><?php esc_html_e('Torna su', 'galleria'); ?></span>
				<svg class="icon" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
