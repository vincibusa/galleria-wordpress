...
<main id="main_content" class="main-content">
	...
	?>
		<article id="post-<?php the_ID(); ?>" <?php post_class('project-single'); ?>>
			...
			<!-- Project Info Section (sotto l'immagine) -->
			<section class="project-info py-12 bg-white">
				<div class="container">
					<div class="max-w-3xl mx-auto">
						<!-- Meta Information -->
						<div class="project-meta mb-6 flex flex-wrap gap-4 text-sm text-gray-600">
							<?php if ($location) : ?>
						...
						<!-- Title -->
						<h1 class="project-title text-4xl md:text-5xl font-light mb-6"><?php the_title(); ?></h1>

						<!-- Artist -->
						<?php if ($artist) : ?>
							<p class="project-artist text-2xl text-gray-700 mb-4"><?php echo esc_html($artist); ?></p>
						<?php endif; ?>

						<!-- Curator -->
						<?php if ($curator) : ?>
							<p class="project-curator text-lg text-gray-600 italic">
			...
			<section class="project-details py-16">
				<div class="container">
					<div class="max-w-4xl mx-auto">
						...
						<!-- Project Info - Clean Layout without labels -->
						<div class="project-info-details border-t border-gray-200 pt-8 space-y-3 text-sm text-gray-700">
							<?php if ($artist) : ?>
			...
			<!-- Navigation -->
			<nav class="project-navigation py-8 border-t bg-white" aria-label="<?php esc_attr_e('Project Navigation', 'galleria'); ?>">
				<div class="container">
					<div class="flex flex-col md:flex-row justify-between items-center gap-4">
						...
						<div class="nav-back">
							<a href="<?php echo esc_url(get_post_type_archive_link('project')); ?>" 
							   ...
							   aria-label="<?php esc_attr_e('Return to all projects', 'galleria'); ?>">
								<?php esc_html_e('All Projects', 'galleria'); ?>
							</a>
						</div>
